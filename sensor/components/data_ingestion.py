...
from sensor.data.sensor_data import SensorData
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)-> DataFrame:
        '''
        Export mongo db collection records as data frame into feature store
        '''
        try:
    ...
    def split_data_as_train_test_split(self, dataframe: DataFrame)-> None:
        '''
        Feature store dataset will be split into train and test files based on train test split ratio
        '''
